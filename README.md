...
Create `analysis/CATEGORY_G_ANALYSIS.md` with this structure:
...
Create `analysis/CATEGORY_G_RESEARCH_QUESTIONS.md` with 30-50 questions.
...
```bash
git add analysis/
git commit -m "Category G Wave 1 analysis complete"
git push
```
...
- [ ] analysis/CATEGORY_G_ANALYSIS.md created
...
- [ ] analysis/CATEGORY_G_RESEARCH_QUESTIONS.md created
